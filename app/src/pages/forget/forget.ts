...
export class forgetPage {
  ...
  constructor(public navCtr: NavController, public homemodel: HomeModel, public storage: StorageService,
    public alertCtrl: AlertController, private wwwname: WwwName, public platform: Platform) {
  ...
  getVCode(){
    ...
    // let url=this.wwwName+"/App/Index/wjPassword";
    // let data={
    //   phone:this.phone
    // }
  ...
  toPassWord(){
    ...
    // this.url = this.wwwName + "/App/Index/setPassword";
    // //post请求   
